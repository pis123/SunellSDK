#ifndef __NEW_SDKS_NAT_H__
#define __NEW_SDKS_NAT_H__
#include "sdk_def.h"

namespace _p2p_sdk_dtls
{
	...
	//����p2p������״̬�ص�
	typedef void(*nat_status_cb)(char* p_sn, int p_status);

	// nat client
	typedef struct nat_cli_man_t* nat_cli_man_h;
	SDKS_API nat_cli_man_h sdks_create_nat_man(bool p_start_dev_search = true);
	SDKS_API int skds_man_set_nat_status_cb(nat_cli_man_h p_man, nat_status_cb p_cb);
